...
# I'm creating classes for each of the visualisations because I want to be able to run them independently
...
class TopArtistsByPosts(Scene):
    def construct(self):
        try:
            ...
            df_top_posts_by_artist = df[df['type']=='Artist'].sort_values(by='count', ascending=False).head(30)

            # Fix: Use robust escape_latex function
            names = [
                escape_latex(name)
                for name in df_top_posts_by_artist['name'].tolist()
            ]
            counts = df_top_posts_by_artist['count'].tolist()
            ...
            # # Title
            title = Text("Top 30 Artists by Posts", font_size=36)
            title.to_edge(UP)
...
class TopGeneralTagsByPosts(Scene):
    def construct(self):
        try:
            # Fix: Use absolute path relative to this script
            script_dir = os.path.dirname(__file__)
            ...
            df_most_posts_by_general = df[df['type']=='General'].sort_values(by='count', ascending=False).head(30)

            # Fix: Use robust escape_latex function
            names = [
                escape_latex(name)
                for name in df_most_posts_by_general['name'].tolist()
            ]
            counts = df_most_posts_by_general['count'].tolist()
            ...
            # # Title
            title = Text("Top 30 General Tags by Posts", font_size=36)
            title.to_edge(UP)
...
class TopCopyrightTagsByPosts(Scene):
    def construct(self):
        try:
            # Fix: Use absolute path relative to this script
            script_dir = os.path.dirname(__file__)
            ...
            df_most_posts_by_copyright = df[df['type']=='Copyright'].sort_values(by='count', ascending=False).head(30)

            # Fix: Use robust escape_latex function
            names = [
                escape_latex(name)
                for name in df_most_posts_by_copyright['name'].tolist()
            ]
            counts = df_most_posts_by_copyright['count'].tolist()
            ...
            # # Title
            title = Text("Top 30 Copyright Tags by Posts", font_size=36)
            title.to_edge(UP)
...
class TopMetadataTagsByPosts(Scene):
    def construct(self):
        try:
            # Fix: Use absolute path relative to this script
            script_dir = os.path.dirname(__file__)
            ...
            df_most_posts_by_metadata = df[df['type']=='Metadata'].sort_values(by='count', ascending=False).head(30)
            # Fix: Use robust escape_latex function
            names = [
                escape_latex(name)
                for name in df_most_posts_by_metadata['name'].tolist()
            ]
            counts = df_most_posts_by_metadata['count'].tolist()
            ...
            # # Title
            title = Text("Top 30 Metadata Tags by Posts", font_size=36)
            title.to_edge(UP)
